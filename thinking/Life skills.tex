...
\end{itemize}
\section{How to learn life skills}
\begin{itemize}
	\item journaling your thoughts helps identifying mistakes
	\item reading can help you discover new concepts
	\item make a unique life plan brings the required state of mind
	\item I need a recurrent task of reciting reminders about mastered skills
	\item I need a recurrent task of updating next skills to learn
	\item I need to understand the relationships between
	\begin{itemize}
		\item problems management tasks
		\item notes management tasks
		\item questions management tasks
		\item solutions maintenance tasks
		\item life planning
	\end{itemize}
\end{itemize}
\end{document}